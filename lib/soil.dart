...
class _SoilListState extends State<SoilList> {
  ...
  List<Soil> soils = [
    Soil(title: 'Alluvial Soil',
        image: Image.asset('assets/images/alluvial.png',fit: BoxFit.fill,),
        index: 0),
    Soil(title: 'Black Soil',
        image: Image.asset('assets/images/black.png',fit: BoxFit.fill,),
        index: 1),
    Soil(title: 'Red and Yellow Soil',
        image: Image.asset('assets/images/red-yellow.png',fit: BoxFit.fill,),
        index: 2),
    Soil(title: 'Laterite Soil',
        image: Image.asset('assets/images/laterite.png',fit: BoxFit.fill,),
        index: 3),
    Soil(title: 'Arid Soil',
        image: Image.asset('assets/images/arid.png',fit: BoxFit.fill,),
        index: 4),
    Soil(title: 'Mountain and Forest Soil',
        image: Image.asset('assets/images/mountain.png',fit: BoxFit.fill,),
        index: 5),
    Soil(title: 'Desert Soil',
        image: Image.asset('assets/images/desert.png',fit: BoxFit.fill,),
        index: 6)
  ];
