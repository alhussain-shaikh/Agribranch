...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    return AnimatedLogin(
      onLogin: (LoginData data) async =>
          _authOperation(LoginFunctions(context).onLogin(data) as Future<String?>),
      onSignup: (SignUpData data) async =>
          _authOperation(LoginFunctions(context).onSignup(data)),
      onForgotPassword: _onForgotPassword,
      logo: Image.asset('assets/images/agrisize.gif'),
  ...
  LoginViewTheme get _desktopTheme => _mobileTheme.copyWith(
    ...
    loadingSocialButtonColor: Colors.white,
  ...
  String get _username => language.code == 'हिंदी' ? 'उपयोगकर्ता नाम' : 'Username';

  String get _login => language.code == 'हिंदी' ? 'लॉगइन' : 'Login';

  String get _signup => language.code == 'हिंदी' ? 'साइनअप' : 'Sign Up';
