              ...
              child: Row(
                children: [
                  ...
                  const CircleAvatar(
                    ...
                    backgroundImage: AssetImage('assets/images/Kisanp.png',),
                  ),
                  Expanded(
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child:  SingleChildScrollView(child: Center(child: Text('What Type of Crop are you growing?',style: GoogleFonts.poppins(color: Colors.white,fontSize: 16),),)),
                      ),
                    ),
                  ),
                ],
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('AgriBranch Bot',style: GoogleFonts.poppins(color: Colors.white,fontSize:32),)
                ],
              ),
            ),
          ),
